 ...
 * 
 * @Package: cn.bocom.other.cache 
 * @author: liushengjie   
 * @date: 2018年8月16日 下午1:48:18 
 */
package cn.bocom.other.cache;
...
public class LocalCacheProviderImpl implements CacheProviderService {
	...
	private static long CACHE_MINUTE = 24 * 60 * 1000;
	private static int CACHE_MAXIMUM_SIZE = 1000000;
	static {
		Cache<String, Object> cacheContainer = CacheBuilder.newBuilder().maximumSize(CACHE_MAXIMUM_SIZE)
				...
				// .expireAfterAccess(CACHE_MINUTE, TimeUnit.MILLISECONDS)
				// //最后一次访问后的一段时间移出
				.recordStats()// 开启统计功能
				.build();

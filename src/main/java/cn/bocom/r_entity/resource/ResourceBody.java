...
@Table(name = "t_res")
@ApiModel("Resource（）")
public class ResourceBody implements Serializable {
     ...
     * @param id ID
     */
    public ResourceBody setId(String id) {
     ...
     * @param name 资源名称
     */
    public ResourceBody setName(String name) {
     ...
     * @param category 资源类别
     */
    public ResourceBody setCategory(String category) {
     ...
     */
    public ResourceBody setConnectType(String connectType) {
     ...
     */
    public ResourceBody setCacheTable(String cacheTable) {
     ...
     * @param num 数据量
     */
    public ResourceBody setNum(Integer num) {
        this.num = num;
        return this;
    }
     ...
     */
    public ResourceBody setCreateUser(String createUser) {
     ...
     */
    public ResourceBody setCreateTime(Date createTime) {
     ...
     */
    public ResourceBody setStatus(String status) {
